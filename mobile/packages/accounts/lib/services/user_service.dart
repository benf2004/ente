...
class UserService {
  ...
  Future<UserDetails> getUserDetailsV2({
    ...
    try {
      ...
      if (shouldCache) {
        // Scoped: these describe one account, and multi-account apps keep
        // several accounts in the same preference store.
  ...
  ///
  /// [navigate] resets the navigation stack to '/' afterwards. Multi-account
  /// apps pass false and handle navigation themselves, once they have decided
  /// which of the remaining accounts to land on.
