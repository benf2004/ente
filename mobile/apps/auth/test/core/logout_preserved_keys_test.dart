...
/// preferences wholesale. These tests pin down what must survive that clear:
/// other profiles' data, the profile registry, and the app-wide lock screen
/// state. Losing any of them turns one account's logout into every account's
/// data loss.
void main() {
