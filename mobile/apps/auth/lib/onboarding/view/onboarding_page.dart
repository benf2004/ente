...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  Future<void> _optForOfflineMode() async {
    ...
    if (hasOptedBefore ||
      ...
      // Give this vault a profile record, or it can never be reached from the
      // switcher once another account is added. No-ops during an add-account
      // flow, where commitAdd does the registering.
